...
<body>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">Soy Galán, un hermoso golden con ojos llenos de esperanza. Fui abandonado en una caja en la puerta de la Fundación PetLove. A pesar de mi difícil comienzo, su cola siempre estaba en movimiento, esperando el amor que tanto ansiaba.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card">
        <div class="card-body text-center">
            ...
            <div class="col-md-4">
                <img src="img/galan.jpg" alt="Imagen" class="custom-image">
            </div>
        </div>
    </div>
